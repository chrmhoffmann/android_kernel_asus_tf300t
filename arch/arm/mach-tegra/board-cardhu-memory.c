...
static const struct tegra_emc_table TF500T_Elpida_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
	...
	},
	{
		...
		204000,     /* SDRAM frequency */
		{
			...
			0x00000000, /* EMC_DLI_TRIM_TXDQS6 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS7 */
			0x0008000c, /* EMC_DLL_XFORM_DQ0 */
			0x0008000c, /* EMC_DLL_XFORM_DQ1 */
			0x0008000c, /* EMC_DLL_XFORM_DQ2 */
			0x0008000c, /* EMC_DLL_XFORM_DQ3 */
			0x000002a0, /* EMC_XM2CMDPADCTRL */
			0x0800211c, /* EMC_XM2DQSPADCTRL2 */
			0x00000000, /* EMC_XM2DQPADCTRL2 */
			0x77fff884, /* EMC_XM2CLKPADCTRL */
...
static const struct tegra_emc_table TF700T_Micron_1GB[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF700T_Elpida_1GB[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table elpida_1GB_EDB8132B2MA_8D_lpddr2_400MHz[] ={
	{
		0x31,       /* Rev 3.1 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table dvfs_TF201_500MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF300T_Elpida_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF300T_Hynix_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF300T_Micron_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF300TG_Elpida_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF300TG_Hynix_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF300TG_Micron_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF300TL_Elpida_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF300TL_Hynix_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table P1801_1GB_800MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
	...
	case BOARD_E1257:
		if(project_info == TEGRA3_PROJECT_TF300T)
		{
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
			{
				...
				tegra_init_emc(TF300T_Elpida_1GB_667MHZ,
					ARRAY_SIZE(TF300T_Elpida_1GB_667MHZ));
			}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:TF300T_Hynix_1GB_667MHZ\n");
				tegra_init_emc(TF300T_Hynix_1GB_667MHZ,
					ARRAY_SIZE(TF300T_Hynix_1GB_667MHZ));
			}
		...
		else if(project_info == TEGRA3_PROJECT_TF300TG)
		{
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
			{
				...
				tegra_init_emc(TF300TG_Elpida_1GB_667MHZ,
					ARRAY_SIZE(TF300TG_Elpida_1GB_667MHZ));
			}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:TF300TG_Hynix_1GB_667MHZ\n");
				tegra_init_emc(TF300TG_Hynix_1GB_667MHZ,
					ARRAY_SIZE(TF300TG_Hynix_1GB_667MHZ));
			}
			else if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==1) )
			{
		...
		else if(project_info == TEGRA3_PROJECT_TF300TL)
		{
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
			{
				...
				tegra_init_emc(TF300TL_Elpida_1GB_667MHZ,
					ARRAY_SIZE(TF300TL_Elpida_1GB_667MHZ));
			}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
			{
		...
		else if(project_info == TEGRA3_PROJECT_TF500T)
		{
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
			{
				printk("BOARD_PM269:TF500T_Elpida_1GB_667MHZ\n");
				tegra_init_emc(TF500T_Elpida_1GB_667MHZ,
					ARRAY_SIZE(TF500T_Elpida_1GB_667MHZ));
			}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
			{
				printk("temp use Elpida replace Hynix\n");
				printk("BOARD_PM269:TF500T_Elpida_1GB_667MHZ\n");
				tegra_init_emc(TF500T_Elpida_1GB_667MHZ,
					ARRAY_SIZE(TF500T_Elpida_1GB_667MHZ));
			}
			...
			if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
				{
					...
					tegra_init_emc(TF700T_Micron_1GB, ARRAY_SIZE(TF700T_Micron_1GB));
				}
			else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
				{
